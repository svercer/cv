                ...
                <div id="cvSection" class="row">
                    ...
                    <div id="columnChange" class="col-md-10">
                        <div id="cvHeading" class="row margin-top-bottom-5">
                            ...
                            <div id="contact" class="col-md-4 text-right margin-top-bottom-5">
                        ...
                        <div class="row">
                            ...
                            <div id="cvRightSide" class="col-md-6">
                                ...
                                <div id="education" class="row">
                                    <div class="col-md-12" id="educationSection">
